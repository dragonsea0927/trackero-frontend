            ...
            <div class="templates-modal-wrapper">
               <div class="templates-modal-container">
                  <div class="templates-modal-title">
                     ...
                     <button
                        @click="toggleList"
                        class="template-modal-toggle-list"
                     >
                        <span
                           v-if="!listCollapsed"
                           class="collapse-icon toggle-list-icon-container"
                        >
                  ...
                  >
                     ...
                     >
                        <router-link
                           @click.native="modalToggle"
                           class="template-board-link"
                           :to="`/board/${board._id}`"
                        >
                           <div
                  ...
                  <div class="working-on-more-templates-container">
                     ...
                     <p>
                        Right place for the templates that help you stay
                        productive
                     </p>
                  </div>
               </div>
