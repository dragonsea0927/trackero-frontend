	...
	>
		<div class="no-back">
			<div class="pop-over-header">
				...
				<span @click="closeModal" class="icon-sm pop-over-header-close-btn"> </span>
			</div>
			<div>
					...
					<div>
						<div>
							<ul class="pop-over-list">
								<li>
									<a class="js-add-card" @click="addTask" href="#">Add card…</a>
								</li>
								<li>
									<a class="js-delete-list" @click="deleteGroup"> Archive this list</a>
								</li>
							</ul>
						</div>
					</div>
